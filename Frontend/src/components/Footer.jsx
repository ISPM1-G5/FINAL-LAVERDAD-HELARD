        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <span className="text-3xl font-bold text-white">La Verdad Herald</span>
            </div>
          ...
          <div className="lg:col-span-4">
            ...
            <form className="flex w-full max-w-sm">
              <input
                ...
                className="w-full grow p-3 rounded-l-md text-white-500 bg-slate-700 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                aria-label="Email Address"
              />
              <button
                type="submit"
                className="bg-cyan-600 hover:bg-cyan-700 p-3 rounded-r-md font-bold text-white uppercase tracking-wider transition-colors"
              >
                Subscribe
              </button>
            </form>
