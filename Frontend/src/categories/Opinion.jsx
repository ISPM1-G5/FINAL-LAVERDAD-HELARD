  ...
  useEffect(() => {
    const fetchOpinionArticles = async () => {
      ...
      try {
        ...
        setError('Failed to load opinion articles. Please try again later.');
        setArticles([]);
        setTotalPages(1);
      } finally {
        setLoading(false);
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto  grow">
        <div className="bg-news-bg bg-cover bg-center h-20" style={{
                  backgroundImage: `linear-gradient(to right, #808080 20%, rgba(128,128,128,0.2)), url('/src/assets/images/bg.jpg' )`
                }}>
