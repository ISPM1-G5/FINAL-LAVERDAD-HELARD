  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
        ...
        <h2 className="mb-1 text-center text-2xl font-bold text-gray-800">Welcome Back!</h2>
        <p className="mb-6 text-center text-gray-600">Sign in to continue to La Verdad Herald</p>
