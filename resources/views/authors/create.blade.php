                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('authors.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea id="social_links" class="form-control @error('social_links') is-invalid @enderror" name="social_links" rows="3" placeholder="Enter social links as JSON">{{ old('social_links') }}</textarea>
