    ...
    const fetchArtArticles = async () => {
      ...
      try {
        const response = await axios.get('/api/articles', {
          params: { category: 'art', page: currentPage }
        });
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto grow">
         <div className="bg-news-bg bg-cover bg-center h-20" style={{
          backgroundImage: `linear-gradient(to right, #C0C0C0 20%, rgba(192,192,192,0.2)), url('/src/assets/images/bg.jpg' )`
        }}>
        ...
        {loading ? (
          ...
          <section className="text-center text-gray-500 justify-center py-5 mt-20">
            ...
            <p>Stay tuned, new stories will be up soon.</p>
          </section>
        ) : (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
